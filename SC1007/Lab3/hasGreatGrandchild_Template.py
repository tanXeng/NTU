...
def hasGreatGrandchild(node):
    ...
    try:
        isGreatGrandparent = (
            node.left.left.left or
            node.left.left.right or
            node.left.right.left or
            node.left.right.right or
            node.right.left.left or
            node.right.left.right or
            node.right.right.left or
